...
<body>
	...
	<form name="form1" action="register_confirm.jsp" method="post"
		...
		<table align="center">
			<tr>
				<td>用户ID：</td>
				<td><input type="text" name="userid" value="12345678">6-8位</td>
			</tr>
			<tr>
				<td>用户名：</td>
				<td><input type="text" name="username" value="胡金广">2-10位</td>
			</tr>
			<tr>
				<td>口令：</td>
				<td><input type="password" name="userpass" value="654321">6-8位，不能与用户ID相同</td>
			</tr>
			<tr>
				<td>确认口令：</td>
			...
			<tr>
				<td>生日：</td>
				<td><input type="text" name="birthday" value="1988-01-27">格式为：1988-1-1</td>
			</tr>
			<tr>
				<td>学历：</td>
			...
			<tr>
				<td>地址：</td>
				<td><input type="text" name="address" value="南京市雨花台区软件大道"></td>
			</tr>
			<tr>
				<td>电话：</td>
			...
			<tr>
				<td>备注：</td>
				<td><textarea rows="8" name="comment" cols="40" onfocus="onTextAreaFocus(form1)">请输入，长度不超过1000字</textarea></td>
			</tr>
			<tr>
